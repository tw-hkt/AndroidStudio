...
<br />
<br />
####看到這個畫面，大概已經成功了一半，KT 這邊貼心的建議，可以先新建一個簡單Hello World專案，來測試開發環境是否真的可以正常編譯執行程式。(尤其老手，可能迫不及待，想立馬載入原 Eclipse 開發的專案，可是有可能環境過程沒弄好，基本的 Hello World 都無法正確建立與執行，所以可以先簡單測試看看)
<br />
